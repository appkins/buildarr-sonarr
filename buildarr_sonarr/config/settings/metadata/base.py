...
class Metadata(SonarrConfigBase):
    ...
    @classmethod
    def _get_remote_map(cls, api_schema: sonarr.MetadataResource) -> List[RemoteMapEntry]:
        return []

    @classmethod
    def _from_remote(
        cls,
        api_schema: sonarr.MetadataResource,
        api_metadata: sonarr.MetadataResource,
    ) -> Self:
        return cls(
            **cls.get_local_attrs(
                remote_map=(
    ...
    def _update_remote(
        ...
        if changed:
            ...
            with sonarr_api_client(secrets=secrets) as api_client:
                sonarr.MetadataApi(api_client).update_metadata(
                    id=api_metadata.id,
                    metadata_resource=sonarr.MetadataResource.from_dict(
