...
class SonarrQualitySettings(SonarrConfigBase):
        ...
        with sonarr_api_client(secrets=secrets) as api_client:
            return cls(
                definitions={
                    ...
                    for api_qualitydefinition in sonarr.QualityDefinitionApi(
                        api_client,
    ...
    def update_remote(
        ...
        changed = False
        with sonarr_api_client(secrets=secrets) as api_client:
            qualitydefinition_api = sonarr.QualityDefinitionApi(api_client)
            ...
            for definition_name, local_definition in self.definitions.items():
                ...
                if updated:
                    ...
                    qualitydefinition_api.update_quality_definition(
                        ...
                        quality_definition_resource=sonarr.QualityDefinitionResource.from_dict(
