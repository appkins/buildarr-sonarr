...
class SonarrNotificationsSettings(SonarrConfigBase):
    # Notification connection settings configuration.
    ...
    def from_remote(cls, secrets: SonarrSecrets) -> Self:
        with sonarr_api_client(secrets=secrets) as api_client:
            api_notifications = sonarr.NotificationApi(api_client).list_notification()
    ...
    def update_remote(
        ...
        with sonarr_api_client(secrets=secrets) as api_client:
            notification_api = sonarr.NotificationApi(api_client)
            api_notification_schemas = notification_api.list_notification_schema()
            api_notifications: Dict[str, sonarr.NotificationResource] = {
    ...
    def delete_remote(self, tree: str, secrets: SonarrSecrets, remote: Self) -> bool:
        ...
        with sonarr_api_client(secrets=secrets) as api_client:
            notification_ids: Dict[str, int] = {
                ...
                for api_notification in sonarr.NotificationApi(api_client).list_notification()
            }
