...
class SonarrDownloadClientsSettings(SonarrConfigBase):
    # Download client settings configuration.
    ...
    def from_remote(cls, secrets: SonarrSecrets) -> Self:
        with sonarr_api_client(secrets=secrets) as api_client:
            api_downloadclients = sonarr.DownloadClientApi(api_client).list_download_client()
    ...
    def update_remote(
        ...
        with sonarr_api_client(secrets=secrets) as api_client:
            downloadclient_api = sonarr.DownloadClientApi(api_client)
    ...
    def delete_remote(self, tree: str, secrets: SonarrSecrets, remote: Self) -> bool:
        ...
        with sonarr_api_client(secrets=secrets) as api_client:
            downloadclient_ids: Dict[str, int] = {
                ...
                for api_downloadclient in sonarr.DownloadClientApi(
                    api_client,
