...
class Condition(SonarrConfigBase):
    # Custom format condition base class.
    #
    # Implements fields common to all condition types, and the Sonarr API functions.
    ...
    def _from_remote(
        ...
        api_condition: sonarr.CustomFormatSpecificationSchema,
    ) -> Self:
        return cls(
            **cls.get_local_attrs(
                remote_map=(
