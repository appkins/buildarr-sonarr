...
class SonarrUISettings(SonarrConfigBase):
    """
    ...
    * `dark` (Dark-coloured theme)
    ...
    """
    The language that Sonarr will use for movie information in the UI.
    ...
    def from_remote(cls, secrets: SonarrSecrets) -> Self:
        with sonarr_api_client(secrets=secrets) as api_client:
            ...
            api_ui_config = sonarr.UiConfigApi(api_client).get_ui_config()
        return cls(
            **cls.get_local_attrs(
    ...
    def update_remote(
        ...
        with sonarr_api_client(secrets=secrets) as api_client:
            ...
            if updated:
                ui_config_api = sonarr.UiConfigApi(api_client)
                config_id = ui_config_api.get_ui_config().id
                ui_config_api.update_ui_config(
                    id=str(config_id),
                    ui_config_resource=sonarr.UiConfigResource.from_dict(
